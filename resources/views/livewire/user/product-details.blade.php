				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            <h2 class="product-name">{{ $product->name }} [{{ $product->colors }}]</h2>
                            ...
                            <div class="stock-info in-stock">
                                <p class="availability">Availability: <b>{{ $product->stuck_status }}</b></p>
                            </div>
                            <div class="quantity">
                            	<span>Quantity:</span>
								...
								<div class="tab-content-item " id="add_infomation">
									<table class="shop_attributes">
										<tbody>
											...
											<tr>
												<th>Dimensions: </th><td class="product_dimensions">{{ $product->dimensions }}</td>
											</tr>
											<tr>
												<th>Color: </th><td><p>{{ $product->colors }}</p></td>
											</tr>
										</tbody>
									</table>
								</div>
                                    ...
                                    <li class="product-item">
                                        <div class="product product-widget-style">
                                            <div class="thumbnnail">
                                                <a href="{{ route('product.details', ['slug'=>$item->slug]) }}" title="Radiant-360 R6 Wireless Omnidirectional Speaker [White]">
                                ...
                                @foreach ($popular as $item)
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{ route('product.details', ['slug'=>$item->slug]) }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        ...
                                        <div class="product-info">
                                            <a href="{{ route('product.details', ['slug'=>$item->slug]) }}" class="product-name"><span>{{ $item->name }} [{{ $item->colors }}]</span></a>
                                            <div class="wrap-price"><span class="product-price">${{ $item->price }}</span></div>
                                        </div>
                                    </div>                                                                   
                                @endforeach
