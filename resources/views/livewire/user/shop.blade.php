						...
						<div class="wrap-right">
							...
							<div class="sort-item orderby ">
								<select name="orderby" class="use-chosen" >
									...
									<option value="price">Sort by price: asset to high</option>
								...
								<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
									<div class="product product-style-3 equal-elem ">
										...
										<div class="product-info">
											<a href="{{ route('product.details', ['slug'=>$product->slug]) }}" class="product-name"><span>{{ $product->name }} [{{ $product->colors }}]</span></a>
					...
					<div class="widget mercado-widget filter-widget">
						...
						<div class="widget-content">
							<ul class="list-style vertical-list has-count-index">
								@foreach ($products as $product)
									<li class="list-item"><a class="filter-link " href="#">{{ $product->colors }} <span>(217)</span></a></li>
