...
<head>
	...
	@livewireStyles
	<script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/poper.min.js"></script>
									...
									@auth
										 @if(Auth::user()->role === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu myprofile" >
													<li class="menu-item" >
														<a title="Dashboard" href="{{ route('admin_dashboard') }}">Dashboard</a>
													</li>
													<li class="menu-item" >
														<a title="Profile" href="{{ route('admin_profile') }}">My Profile</a>
													</li>
													<li class="menu-item" >
										...
										@elseif(Auth::user()->role === 'USR')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu myprofile" >
													<li class="menu-item" >
														<a title="Dashboard" href="{{ route('user_dashboard') }}">Dashboard</a>
													</li>
													<li class="menu-item" >
														<a title="Profile" href="{{ route('user_profile') }}">My Profile</a>
													</li>
													<li class="menu-item" >
														<form action="{{ route('logout') }}" method="post">
															@csrf
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="" alt="LOGO"></a>
						</div>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{ route('user_shop') }}" class="link-term mercado-item-title">Shop</a>
								</li>
								<li class="menu-item">
